...
%程序输入为期望的末端位姿矩阵T,和机器人当前的关节角a(单位：弧度），其中T为4*4的矩阵,a为6维行矢量
%程序输出为满足末端位姿矩阵的关节角joint,和判断是否奇异的标志位dd，其中joint为6维行矢量，当dd=1时不奇异，当dd=0时，存在奇异问题。
